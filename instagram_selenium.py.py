...
class Instagram:
    ...
    driver_path = "/Users/emre/Drivers/chromedriver"
...
app.signIn()    
# app.followUser('mtalhakesler')
app.followUsers(["mtalhakesler","sezeravci"])

# app.unFollowUser('mtalhakesler')
# app.unFollowUser('sezeravci')

app.unFollowUsers(["mtalhakesler","sezeravci"])
